...
```
Splitting the different conditions is done for ChestPainType otherwise the column can't be used for making Principal component analysis. The data set don't have missing values. 
...
Information about the meaning of every attribute can be found in the following link. 
